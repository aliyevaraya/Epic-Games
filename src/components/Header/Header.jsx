...
function Header() {
  ...
  return (
    <>
      <header className={`bg-[#121216] flex justify-between px-3 sm:px-[20px] text-white ${show ? `hidden lg:flex` : "flex"}`}>
      ...
      <div
        className={`text-white relative bg-[#101014] ${
          show ? `block lg:hidden ` : "hidden"
        }`}
      >
        <div className="flex justify-between p-[20px] fixed top-0  w-full z-[2]">
