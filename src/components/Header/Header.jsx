    ...
    <>
      {show ? (
        <div className="text-white relative">
          <div className="bg-[#101014] flex justify-between p-[16px] fixed top-0  w-full z-[2]">
          ...
          <ul className="tracking-[0.02em] bg-[#101014] p-4 flex flex-col gap-10 pt-[10vh] fixed w-full h-full top-0 left-0  overscroll-contain overflow-y-auto no-scrollbar">
        ...
        <header className="bg-[#18181c] flex justify-between p-4">
          ...
          <div className="flex gap-4 items-center">
            <a
              href="#"
              className="bg-[#26bbff] hover:bg-[#72d3ff] py-[3px] px-[8px] rounded-md"
            >
              Download
            </a>
            <button>
