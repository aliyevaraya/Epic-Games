  ...
  return (
    <>
      <div className="relative">
        <div className={`sticky top-0 z-[2] bg-[#101014] text-white`}>
          <div className="w-[90%]  lg:w-[75%] h-[100px] m-auto flex items-center justify-between">
            ...
            <div className="h-[80px] lg:relative static flex flex-col items-center m-auto w-[80%] justify-center lg:items-start ml-[20px]">
              ...
              <div
                className={`w-full lg:w-[200px] h-screen lg:h-auto 2xl:h-full absolute 2xl:static top-[100%] lg:top-[90%] -left-[10px] z-[2] ${
