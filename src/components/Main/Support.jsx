      ...
      <section id="self-service" className="py-[80px]">
        <div className="container">
          <div className="self-service flex flex-col md:flex-row md:flex-wrap gap-4">
            ...
            {!showAll && (
              <div className="all-serv flex items-center relative py-5 h-[90px] px-5 gap-3 bg-[#ffffff0a] rounded-lg w-full md:w-[calc(50%-8px)] 2xl:w-[calc(33.3%-8px)] cursor-pointer">
                <div className="icon">
                  <svg
                    width="24"
                    height="24"
